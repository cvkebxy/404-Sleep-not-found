...
<body class="accessibility-normal" data-logged-in="<?php echo $is_logged_in ? 'true' : 'false'; ?>" data-user-id="<?php echo $user_id; ?>">
        ...
        <div class="auth-dialog">
            ...
            <form id="loginForm" class="auth-form active" action="php/auth.php" method="POST">
                ...
                <div class="form-group checkbox-group" style="display: flex; justify-content: space-between; align-items: center;">
                    <div style="display: flex; align-items: center;">
                        ...
                        <label for="rememberMe" style="margin-bottom: 0;">Запомнить меня</label>
                    </div>
                    <button type="button" class="forgot-password-btn" onclick="openForgotPasswordModal()">
                        Забыли пароль?
                    </button>
                </div>
            ...
            <form id="forgotPasswordForm" class="auth-form">
                ...
                <div class="password-recovery-info">
                    Введите свой email, указанный при регистрации, и на него будет отправлено письмо с дальнейшими инструкциями по восстановлению пароля.
                </div>

                <div class="form-group">
                    <label for="recoveryEmail">Email</label>
                    <input type="email" id="recoveryEmail" name="email" required placeholder="Ваш email">
                </div>

                <button type="submit" class="auth-submit">ВОССТАНОВИТЬ ПАРОЛЬ</button>

                <div class="recovery-help">
                    <strong>Что делать если письмо не приходит?</strong><br>
                    • Проверьте папку "Спам" в вашей почте<br>
                    • Убедитесь, что вводите правильный email<br>
                    • Попробуйте повторить запрос через 5 минут<br>
                    • Если проблема сохраняется, напишите в поддержку
                </div>

                <p class="back-switch">
                    <a href="#" onclick="backToLogin(); return false;">← Вернуться к входу</a>
                </p>
            </form>
        </div>
    </div>
    ...
    <div id="regModal" class="auth-modal">
        <div class="auth-dialog large">
            ...
            <form id="registerForm" class="auth-form active" method="POST">
                ...
                <!-- Поле для кода подтверждения (изначально скрыто) -->
                <div id="codeSection" class="form-group" style="display: none;">
                    <label for="registerCode">Код подтверждения</label>
                    <input type="text" id="registerCode" name="code" placeholder="Введите код из email" maxlength="4">
                    <small>Проверьте вашу почту и введите 4-значный код</small>
                </div>
                        ...
                        <div class="profile-grid">
                            ...
                            <div class="profile-section" id="userProjectsSection">
                                <div class="profile-section-header">
                                    <h3>Мои проекты</h3>
                                    <button type="button" class="profile-btn-text" onclick="openCreateCardModal()">
    ...
    <div id="changePasswordModal" class="auth-modal" style="display: none;">
        <div class="auth-dialog">
            <button class="close-dialog" onclick="closeChangePasswordModal()">×</button>
            ...
            <form id="changePasswordForm" class="auth-form active">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="currentPassword" name="current_password" required placeholder="Введите текущий пароль">
                </div>

                <!-- Новый пароль (изначально скрыт) -->
                <div id="newPasswordSection" style="display: none;">
                    <div class="form-group">
                        <label for="newPassword">Новый пароль</label>
                        <input type="password" id="newPassword" name="new_password" placeholder="Введите новый пароль" minlength="6">
                    </div>
                    <div class="form-group">
                        <label for="confirmNewPassword">Подтвердите новый пароль</label>
                        <input type="password" id="confirmNewPassword" name="confirm_new_password" placeholder="Повторите новый пароль">
                    </div>
                </div>

                <button type="submit" class="auth-submit" id="changePasswordSubmit">
                    ПРОВЕРИТЬ ПАРОЛЬ
                </button>
            </form>
        </div>
